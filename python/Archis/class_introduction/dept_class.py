class Course:
    ...
    def __init__(self,course_name,semester,department_name ,capacity = 10):
...
class Student:
    ...
    def enroll_to_course(self,course):
        ...
        if course.department_name == self.department:
        #Condition for checking the course capacity
            ...
            #Checking the course availability on the basis of year
                ...
                #Checking the availability on the basis of semester
                    ...
                    #Appending all student objects in the course enrollments list  
                            ...
                            print ("Cannot enroll student", self.name ,':', course.course_name, 'is not available in current semester')
                    else:
                        print ("Cannot enroll student" ,self.name,':', course.course_name, 'is not available for',self.year)
            ...
            print ('Cannot enroll student', self.name,':', course.course_name,'is not available for:',self.department)
...
if __name__ == "__main__":
    ...
    course1 = Course('VLSI','VIII','E&TC')
    course2 = Course('EDC','IV','E&TC')
    course3 = Course('SS','III','E&TC')
    course4 = Course('Physics','I','E&TC')
    course5 = Course('Microprocessor','V','E&TC')
    course6 = Course('BCS','VII','E&TC')
    course7 = Course('Maths','I','E&TC')
    ...
    prof5 = Professor('Nilesh',['HT','RAAC','MQC'])
